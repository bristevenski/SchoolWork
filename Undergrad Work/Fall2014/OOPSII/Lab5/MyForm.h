...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
         ...
         // button1
         // 
         this->button1->Location = System::Drawing::Point(102, 226);
         ...
         this->timerSpeedTrackBar->Location = System::Drawing::Point(168, 12);
...
private: System::Void MyForm_MouseDown(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
            if (e->X < (ball_x + BALLSIZE) && e->X > ball_x && e->Y < (ball_y + BALLSIZE) && e->Y > ball_y)
            {
