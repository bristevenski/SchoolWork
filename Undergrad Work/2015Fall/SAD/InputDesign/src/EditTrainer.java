...
public class EditTrainer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Plyometrics\nAerobics\nSpinning");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(60, 50, 166, 80);

        jButton1.setText("SAVE");
        getContentPane().add(jButton1);
        jButton1.setBounds(310, 170, 57, 23);

        jButton2.setText("CANCEL");
        getContentPane().add(jButton2);
        jButton2.setBounds(230, 170, 71, 23);

        jButton3.setText("BACK");
        getContentPane().add(jButton3);
        jButton3.setBounds(10, 170, 59, 23);

        jButton4.setText("EDIT CLASS LIST");
        jButton4.setToolTipText("");
        getContentPane().add(jButton4);
        jButton4.setBounds(240, 50, 120, 23);
