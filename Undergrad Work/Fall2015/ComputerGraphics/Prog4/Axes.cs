...
public class Axes
{
   private const int POS_INDEX = 0;
   private const int COL_INDEX = 1;
   private const int NOR_INDEX = 2;
   ...
   /// <summary>
   /// Draws the axes according to their definition in verts. Loads the
   /// matrix based on the given lookAt matrix.
   /// </summary>
